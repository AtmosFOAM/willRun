...
writeCellDataxyz -case $case b
writeCellDataxyz -case $case P
writeCellDataxyz -case $case sigma
writeCellDataxyz -case $case uz
for time in [0-9]*; do
    cp $case/$time/*.xyz conditionallyAveraged/1col/$time/
done
